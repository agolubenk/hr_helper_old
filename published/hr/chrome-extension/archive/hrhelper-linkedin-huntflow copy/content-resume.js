...
(function () {
  ...
  function createResumeFloatingWidget() {
    ...
    body.style.cssText = 'display:flex;flex-direction:column;gap:8px;flex:1;min-height:0;overflow-y:auto;font-size:13px;line-height:1.4;color:var(--hrhelper-text,#333);';
  ...
  function processLink(link) {
    ...
    Promise.all([
      ...
      if (hasContent) showFloatingWidget(candidateInfo, vacancies);
    }).catch(() => {});
  }
  ...
  function injectSavedLinkBlock() {
    ...
    function renderBlock(state) {
      ...
      Promise.all([
        ...
        showFloatingWidget(candidateInfo, vacancies, options);
