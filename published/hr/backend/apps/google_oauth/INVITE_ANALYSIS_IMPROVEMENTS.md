...
- ✅ Проверка валидных временных слотов (минуты кратны 5: 00, 05, 10, …, 55)
...
- Временные слоты: **кратно 5 минут** (00, 05, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55)
- Если пользователь указал время, кратное 5 — оно используется как есть; иначе округление до ближайшего слота
...
TIME_SLOTS = [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55]  # кратно 5 минут
```
